...
for prod in (aerosol_prod, total_precip, atm_profile):
    ...
    # prod = aerosol_prod
    url_base = 'https://ladsweb.modaps.eosdis.nasa.gov/archive/allData/61/{0}/{1}/{2:0>3}/'.format(prod, year, doy)
    print(url_base)
